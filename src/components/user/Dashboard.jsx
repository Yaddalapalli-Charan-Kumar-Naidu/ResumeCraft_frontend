      ...
      {Array.isArray(resumeData.resumes) && resumeData.resumes.length > 0 ? (
        resumeData.resumes.map((resume) => (
          <div
            ...
            className="w-[15vw] h-[40vh] border border-purple-600 rounded-lg flex flex-col justify-between text-center text-2xl shadow-lg hover:shadow-purple-300 hover:shadow-lg cursor-pointer"
            style={{
              backgroundImage:
